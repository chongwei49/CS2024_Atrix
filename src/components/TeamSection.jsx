...
export default function TeamSection() {
  return (
    ...
    <div class="flex flex-col text-center w-full mb-12 mt-12">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">With a shared commitment to excellence and a relentless pursuit of perfection, the Atrix team strives to redefine the future of computing, one laptop at a time.</p>
    </div>
