...
export default function CheckoutPage() {
    return (
        <>
            <div class="flex flex-col text-center w-full mb-3 mt-12">
            ...
            <div class="grid sm:px-10 mb-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div class="px-4 pt-8">
                    <p class="text-xl font-medium">Order Summary</p>
                    <p class="text-gray-400">Check your items. And select a suitable shipping method.</p>
                    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                        <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                            <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="images/image2.jpeg" alt="" />
                            <div class="flex w-full flex-col px-4 py-4">
                                <span class="font-semibold">ROG Zephyrus M16 GU604VI-N4062W</span>
                                <span class="float-right text-gray-400">32GB / 2TB</span>
                                <p class="text-lg font-bold">$4,598.00</p>
                            </div>
                        </div>
                    ...
                    <form class="mt-5 grid gap-6">
                        ...
                        <div class="relative">
                            ...
                            <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
                                ...
                                <div class="ml-5">
                                    <span class="mt-2 font-semibold">Furious Delivery</span>
                                    <p class="text-slate-500 text-sm leading-6">Delivery: 1 Day</p>
                                </div>
                            </label>
                        </div>
                    </form>
                    ...
                    <div class="">
                        ...
                        <div class="mt-6 border-t border-b py-2">
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-semibold text-gray-900">$4,598.00</p>
                            </div>
                            <div class="flex items-center justify-between">
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">$4,598.00</p>
                        </div>
                    </div>
                    <button class="mt-4 mb-8 w-full rounded-md bg-cyan-700 px-6 py-3 font-medium text-white">Place Order</button>
                </div>
            </div>
        </>
    )
